...
class StorekeeperView extends StatefulWidget {
  const StorekeeperView({Key? key}) : super(key: key);

  @override
  State<StorekeeperView> createState() => _StorekeeperViewState();
}

class _StorekeeperViewState extends State<StorekeeperView> {
  @override
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final place = storekeeperData['place'] ?? '';
              final status = storekeeperData['status'] ?? '';
              final isAccepted = status == 'Accepted';
              return _buildCard(
                  storekeeperName, email, phoneNumber, place, isAccepted);
            },
          );
        },
      ),
