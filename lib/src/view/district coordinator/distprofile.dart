...
class DistProfile extends StatefulWidget {
  const DistProfile({Key? key}) : super(key: key);

  @override
  State<DistProfile> createState() => _DistProfileState();
}

class _DistProfileState extends State<DistProfile> {
